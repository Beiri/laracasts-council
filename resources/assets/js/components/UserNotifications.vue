<template>
  <div @mouseover="active = true" @mouseout="active = false">
    ...
    >
      ...
      <div
        class="rounded-full bg-red w-2 h-2 absolute pin-t pin-r mt-1"
    ...
    <div class="relative" v-show="active">
      ...
      <div
        class="bg-grey-light p-6 text-black absolute rounded"
      ...
      >
        ...
        <ul class="list-reset">
          ...
          >
            ...
            >
              <img
                :src="notification.data.notifier.avatar_path"
          ...
          <li v-if="!notifications.length" class="text-xs">
