<template>
  <div
    :id="'reply-' + id"
    class="border-b border-grey-lighter py-8"
        ...
        <div class="flex items-center mb-6 mt-2">
          <div class="flex flex-1">
            ...
            <a
              v-if="
                !editing &&
                  (authorize('owns', reply) || authorize('owns', reply.thread))
              "
              href="#"
          ...
          <div class="text-2xs flex items-center">
            <a
              ...
              href="#"
              class="mr-2 font-bold flex items-center"
              :class="bestReplyClasses"
              @click.prevent="markBestReply"
            >
              <span
                v-text="isBest ? 'Best Answer!' : 'Best Answer?'"
                class="mr-2"
              ></span>
              <svg
                ...
                viewBox="0 0 20 20"
                class="fill-current"
                :class="isBest ? 'text-green' : 'text-grey-light'"
              >
                <path
                  fill-rule="evenodd"
          ...
          <div v-if="editing">
            <form @submit.prevent="update">
              ...
              <div class="flex justify-between">
                ...
                <div>
                  <button class="btn mr-2" @click="cancel" type="button">
                    Cancel
                  </button>
