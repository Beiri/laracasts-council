<nav class="bg-blue-darker py-4">
    <div class="container mx-auto flex justify-between items-center text-blue-lightest pl-6">
        ...
        <div class="flex" v-cloak>
            <div class="search-wrap rounded-full bg-blue-darkest w-10 cursor-pointer h-10 flex items-center justify-center mr-4 relative"
                @mouseover="search" @mouseout="searching = false">
                <form method="GET" action="/threads/search" v-show="searching">
                    <input type="text" placeholder="Search for something..." name="q" ref="search"
