<aside class="bg-grey-lightest p-6 pr-10 border-l border-r w-64">
    ...
    <div class="widget border-b-0">
        @if (auth()->check())
            ...
            @else
                <p class="text-xs text-grey-dark font-bold border border-dashed border-grey-dark p-3">Please confirm your
                    email address to participate.</p>
            @endif
        @else
    ...
    <div class="widget">
        ...
        <ul class="mb-2 list-reset text-sm">
            ...
            @if (auth()->check())
                <li class="pb-3">
                    <a href="/threads?by={{ auth()->user()->username }}"
                        ...
                        <img src="{{ auth()->user()->avatar_path }}" alt="{{ auth()->user()->username }}"
            ...
            <li>
                <a href="/leaderboard"
                    class="flex items-center text-grey-darkest hover:text-blue hover:font-bold {{ request()->getPathInfo() === '/leaderboard' ? 'text-blue font-bold' : '' }}">
